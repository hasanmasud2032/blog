            ...
            <div class="header__content row">
                ...
                <nav class="header__nav-wrap">
                    ...
                    <ul class="header__nav">
                        <li><a href="{{route('frontend.blog.view')}}" title="">Home</a></li>
        ...
        <article class="row format-standard">
            ...
            <div class="s-content__header col-full">
                ...
                <ul class="s-content__header-meta">
                    <li class="date">{{$blog->custom_date}}</li>
                    <li class="cat">
                        In
                        <a href="#0">{{ucfirst($blog->category->name)}}</a>
                    </li>
                </ul>
            ...
            <div class="s-content__media col-full">
                ...
                <img src="{{ asset('uploads/images/'.$blog->image_path) }}"
                 alt="Image" style="width:100%;max-height:400px">
                </div>
